...
cfg.controllerStatusMessageLength = 12;
...
% 生成 cfg_<字段名> 兼容变量，供迁移后的各 MATLAB Function 直接引用。
...
clear projectDir repoDir fr3 cameraBody cameraJoint ...
    T_W_CL0 cfgFieldNames cfgFieldIndex cfgFieldName;
